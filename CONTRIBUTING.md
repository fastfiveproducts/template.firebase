...
This repository and derivations thereof may include open-source templates, internal projects, and client-facing software.  To maintain consistency and legal clarity, we follow structured header practices for all source files.

---

## File Headers

All GQL source files should include a standard file header that provides authorship, licensing, and version context. There are two header formats depending on who authored the file.
...
When modifying an FFP template file within an app, keep the existing header and add a "Modified by" line below the "Created by" line.
...
#  [Filename].gql
#
#  Created by [Developer Name][, Company Name if applicable].
#      Template v0.2.x — Fast Five Products LLC's public AGPL template.
#
#  Copyright © 2025 [Developer Name][, Company Name if applicable].
#  All rights reserved.
#
